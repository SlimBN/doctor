...
class SymptomsControllerTest < ActionController::TestCase
  ...
  test "should create symptom" do
    assert_difference('Symptom.count') do
      post :create, symptom: { definition: @symptom.definition, illness_id: @symptom.illness_id, name: @symptom.name }
    end
  ...
  test "should update symptom" do
    put :update, id: @symptom, symptom: { definition: @symptom.definition, illness_id: @symptom.illness_id, name: @symptom.name }
    assert_redirected_to symptom_path(assigns(:symptom))
  end
